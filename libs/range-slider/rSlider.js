(function () {
	...
	RS.prototype.createSlider = function () {
		...
		console.log('sliderWidth', this.slider.getBoundingClientRect(), this.slider.clientWidth);
	...
	RS.prototype.onResize = function () {
		console.log('onResize', this.slider.getBoundingClientRect(), this.slider.clientWidth);
		this.sliderLeft = this.slider.getBoundingClientRect().left;
		this.sliderWidth = this.slider.clientWidth;
